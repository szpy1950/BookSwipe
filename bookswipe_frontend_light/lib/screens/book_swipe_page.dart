              ...
              child: Dismissible(
                ...
                background: Container(
                  decoration: BoxDecoration(
                    color: const Color(0xFFD2691E).withOpacity(0.2),  // Changed from green to warm brown
                  ...
                  child: const Align(
                    ...
                    child: Padding(
                      ...
                      child: Icon(Icons.favorite, color: Color(0xFFD2691E), size: 40),  // Changed from green to match background
                    ),
                  ),
                ),
                secondaryBackground: Container(
                  decoration: BoxDecoration(
                    color: const Color(0xFF8B4513).withOpacity(0.2),  // Changed from red to dark brown
                    borderRadius: BorderRadius.circular(10),
                  ),
                  child: const Align(
                    ...
                    child: Padding(
                      ...
                      child: Icon(Icons.close, color: Color(0xFF8B4513), size: 40),  // Changed from red to match background
                    ),
                  ),
                ),
                child: Card(
